...
@Component({
  ...
  selector: 'app-fintech-grid',
  templateUrl: './fintech-grid.component.html',
  styleUrls: ['./fintech-grid.component.scss']
})
export class FintechGridComponent implements OnInit, AfterViewInit, OnDestroy {
